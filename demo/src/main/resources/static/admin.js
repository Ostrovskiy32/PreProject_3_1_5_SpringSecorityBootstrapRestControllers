...
const renderPosts = (users) => {
    ...
    users.forEach((u) => {
        ...
        temp += `<tr>
                                    <td>${u.userId}</td>
                                    <td id=${'name' + u.userId}>${u.name}</td>
                                    <td id=${'surname' + u.userId}>${u.surname}</td>
                                    <td id=${'age' + u.userId}>${u.age}</td>
                                    <td id=${'citizenship' + u.userId}>${u.citizenship}</td>
                                    <td id=${'username' + u.userId}>${u.username}</td>
                                    <td id=${'role' + u.userId}>${rolesStr}</td>
    
                                    <td>
                                    <button class="btn btn-info" type="button"
                                    data-toggle="modal" data-target="#modalEdit"
                                    onclick="editModal(${u.userId})">Edit</button></td>
    
                                    <td>
                                    <button class="btn btn-danger" type="button"
                                    data-toggle="modal" data-target="#modalDelete"
                                    onclick="deleteModal(${u.userId})">Delete</button></td>
                                    </tr>
                                    `
    })
...
async function addUser() {
    ...
    let citizenshipValue = document.getElementById("citizenship").value;
...
function deleteModal(id) {
    fetch(url + id, {
        ...
        res.json().then(us => {
            ...
            document.getElementById('idDelete').value = us.userId;
            ...
            document.getElementById('citizenshipDelete').value = us.citizenship;
...
function editModal(id) {
    ...
    fetch(url + id, {
        ...
        res.json().then(us => {
            ...
            document.getElementById('idEdit').value = us.userId;
            ...
            document.getElementById('citizenshipEdit').value = us.citizenship;
...
async function editUser() {
    ...
    let citizenshipValue = document.getElementById("citizenshipEdit").value;
